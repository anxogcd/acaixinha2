...
import { UnshareMemoryCommand } from "./UnshareMemoryCommand.js";
...
@injectable()
export class UnshareMemoryCommandHandler {
  ...
  async execute(command: UnshareMemoryCommand): Promise<Memory> {
    ...
    this.sharingService.unshareMemory(memory, targetUser);
